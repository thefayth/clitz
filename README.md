![CLITZ hero](assets/hero/hero-image.png)
...
![CLITZ banner](assets/banners/github-banner.png)
...
| ![Project icon](assets/icons/project-icon.png) | Project icon |
| ![Editorial card](assets/gallery/editorial-card.png) | Directory/gallery visual |
